          ...
          <div className='work__content_examples'>
            <div className='example'>
              ...
              <div className='overlay'>
                <a href='https://github.com/tombrzo' className='overlay__text'>Portfolio</a>
                <a href='https://github.com/tombrzo' className='overlay__sentence'>See on GitHub</a>
              </div>
            </div>
            <div className='example'>
              <img className='example__picture' src='img/clone.png' alt='' />
              <div className='overlay'>
                <a href='https://github.com/tombrzo' className='overlay__text'>Facebook-Clone</a>
                <a href='https://github.com/tombrzo' className='overlay__sentence'>See on GitHub</a>
              </div>
            </div>
            <div className='example'>
              ...
              <div className='overlay'>
                <a href='https://github.com/tombrzo' className='overlay__text'>Travel</a>
                <a href='https://github.com/tombrzo' className='overlay__sentence'>See on GitHub</a>
              </div>
            </div>
            <div className='example'>
              ...
              <div className='overlay'>
                <a href='https://github.com/tombrzo' className='overlay__text'>Weather App</a>
                <a href='https://github.com/tombrzo' className='overlay__sentence'>See on GitHub</a>
              </div>
            </div>
            <div className='example'>
              ...
              <div className='overlay'>
                <a href='https://github.com/tombrzo' className='overlay__text'>AppLab-Landing Page</a>
                <a href='https://github.com/tombrzo' className='overlay__sentence'>See on GitHub</a>
              </div>
            </div>
            <div className='example'>
              <img className='example__picture' src='img/notify.png' alt='' />
              <div className='overlay'>
                <a href='https://github.com/tombrzo' className='overlay__text'>Notify - Landing Page</a>
                <a href='https://github.com/tombrzo' className='overlay__sentence'>See on GitHub</a>
              </div>
            </div>
          </div>
