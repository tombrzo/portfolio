...
const AboutPage = () => {
  return ( 
    <>
      <div className='about__container animate'>
        <div className='about__title-wrapper'>
          ...
          <div className='about__title-wrapper_underline'></div>
        </div>
        <div className='about__content_wrapper'>
          <div className='about__content_text'>
            ...
            I define myself by the work I want to do. Skills can be taught, personality is is the sum 
            ...
            I’ve worked with people for people. However the global crisis caused by the Covid-19 pandemic 
            has presented me with new challenges. 
            </p>
            <p className='about__content_sentence'>
